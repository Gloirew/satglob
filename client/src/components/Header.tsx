      ...
      >
        <div className="px-4 py-4 space-y-2 border-t border-cyan-500/10 bg-[#030712]/95 backdrop-blur-xl">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMobileOpen(false)}
            className="flex items-center justify-center gap-2 w-full mt-2 px-4 py-3 rounded-lg border border-green-500/20 bg-green-500/10 text-green-400 hover:bg-green-500 hover:text-white transition-all duration-300 font-medium"
          >
