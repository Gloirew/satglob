    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-1/2 right-[10%] -translate-y-1/2 hidden lg:block pointer-events-none">
        <div className="relative w-[300px] h-[300px]">
          <div className="absolute inset-0 border border-cyan-500/10 rounded-full" style={{ transform: "rotateX(60deg) rotateZ(20deg)" }} />
          <div className="absolute inset-4 border border-cyan-400/15 rounded-full" style={{ transform: "rotateX(60deg) rotateZ(-15deg)" }} />
          <div className="absolute w-2 h-2 bg-cyan-400 rounded-full shadow-lg shadow-cyan-400/50" style={{ top: "50%", left: "50%", animation: "orbit 8s linear infinite" }} />
          <div className="absolute w-1.5 h-1.5 bg-blue-400 rounded-full shadow-lg shadow-blue-400/50" style={{ top: "50%", left: "50%", animation: "orbit 12s linear infinite reverse" }} />
      ...
      <div className="container relative z-10 pt-32 pb-20 lg:pt-40 lg:pb-32">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cyan-500/30 bg-cyan-500/10 backdrop-blur-sm mb-8 transition-all duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          {/* Title */}
          <h1 className={`text-4xl sm:text-5xl lg:text-7xl font-extrabold leading-[1.05] tracking-tight text-white mb-6 transition-all duration-1000 delay-200 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            {t("hero.title1")}{" "}
          ...
          {/* Subtitle */}
          <p className={`text-lg sm:text-xl text-gray-300 mb-4 font-light tracking-wide transition-all duration-1000 delay-400 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            {t("hero.subtitle")}
          </p>
          <p className={`text-base text-gray-400 mb-10 max-w-xl leading-relaxed transition-all duration-1000 delay-500 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            {t("hero.description")}
          </p>

          {/* CTAs */}
          <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-600 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <a
              href="#solutions"
          ...
          {/* Trusted by */}
          <div className={`mt-16 pt-8 border-t border-white/5 transition-all duration-1000 delay-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden lg:flex flex-col items-center gap-2">
        <span className="text-xs text-gray-500 font-[Inter_Tight]">{t("hero.scroll")}</span>
